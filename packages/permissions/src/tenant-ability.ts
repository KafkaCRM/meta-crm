...
const DEFAULT_PERMISSIONS = [
  ...
  { action: 'create' as TenantAction, resource: 'Lead' as TenantSubject },
  { action: 'read' as TenantAction, resource: 'Lead' as TenantSubject },
  { action: 'update' as TenantAction, resource: 'Lead' as TenantSubject },
