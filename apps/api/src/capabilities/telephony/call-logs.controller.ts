...
class CreateCallLogDto {
  ...
  @IsOptional() @IsNumber() duration_secs?: number;
  @IsOptional() @IsString() status?: string;
  @IsOptional() @IsString() recording_url?: string;
  @IsOptional() @IsString() twilio_call_sid?: string;
  @IsOptional() @IsString() notes?: string;
  @IsOptional() @IsDateString() started_at?: string;
  @IsOptional() @IsDateString() ended_at?: string;
}

class UpdateCallLogDto {
  @IsOptional() @IsNumber() duration_secs?: number;
  @IsOptional() @IsString() status?: string;
  @IsOptional() @IsString() recording_url?: string;
  @IsOptional() @IsString() notes?: string;
...
@RequireCapability('capability/telephony')
...
export class CallLogsController {
  ...
  async create(@Body() dto: CreateCallLogDto) {
  ...
  async findAll(@Query() q: CallLogListQuery) {
  ...
  async update(@Param('id') id: string, @Body() dto: UpdateCallLogDto) {
