  ...
  return (
    <Card className="bg-card border-border rounded-xl shadow-none hover:shadow-md transition-shadow h-full flex flex-col justify-between overflow-hidden">
        ...
        <div className="flex items-center justify-between">
          <div className="space-y-0.5">
            <CardTitle className="text-sm font-semibold text-foreground flex items-center gap-1.5">
              Daily Priorities
              {activeCount > 0 && (
                <Badge className="bg-fin-orange text-white font-bold text-[9px] px-1.5 py-0 rounded-full">
                  {activeCount}
                </Badge>
              )}
            </CardTitle>
      ...
      <CardContent className="p-0 flex-1 divide-y divide-[#e2e8f0]">
          ...
          return (
            <div 
              ...
              className={cn(
                ...
                task.completed ? "bg-muted/40 opacity-60" : "hover:bg-muted/30"
              )}
            >
              {/* Completed Checkbox */}
              <div className="pt-0.5">
                <Checkbox 
                  ...
                  className="rounded-full h-4 w-4 border-[#cbd5e1] text-foreground focus-visible:ring-indigo-500"
                />
              </div>
              ...
              <div className="flex-1 min-w-0">
                  ...
                  {!task.completed && (
                    <Badge 
                      ...
                      className={cn(
                        ...
                        task.priority === 'low' && "bg-muted text-muted-foreground border-border/50"
                      )}
                    >
                      {task.priority}
                    </Badge>
                ...
                <div className="text-[10px] text-muted-foreground mt-1 flex items-center gap-2 flex-wrap">
                  ...
                  <span className={cn(
                    ...
                    isOverdue && !task.completed ? "text-red-500 font-bold" : "text-muted-foreground"
                  )}>
                  ...
                  {task.type === 'call' && (
                    <>
                      <Button 
                        ...
                        className="h-6 w-6 text-slate-450 hover:text-fin-orange hover:bg-muted/70 rounded-md"
                      ...
                      {task.phone && (
                        <WhatsAppButton
                          ...
                          variant="ghost"
                          size="icon"
                          className="h-6 w-6 border-0 text-slate-450 hover:text-emerald-600 hover:bg-muted/70 rounded-md p-0 flex items-center justify-center"
        ...
        {activeCount === 0 && (
          <div className="p-8 text-center space-y-2 bg-muted/15">
            ...
            <div>
              ...
              <p className="text-[10px] text-muted-foreground max-w-[200px] mx-auto leading-normal mt-0.5">All daily priority follow-ups and outreach calls have been resolved.</p>
            </div>
          </div>
        )}
      </CardContent>
