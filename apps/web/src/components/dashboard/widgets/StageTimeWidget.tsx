    ...
    return (
      <Card className={`bg-white border-[#d3cec6] rounded-xl shadow-none ${className ?? ''}`}>
        <CardHeader className="pb-2">
          <CardTitle className="text-sm font-semibold text-[#111111]">Avg Time per Stage</CardTitle>
        </CardHeader>
      ...
      <Card className={`bg-white border-[#d3cec6] rounded-xl shadow-none ${className ?? ''}`}>
        <CardContent className="pt-5 pb-5">
          <div className="flex items-center justify-between">
            <div>
              <p className="text-xs font-medium text-[#9c9fa5] uppercase tracking-wider mb-1">Avg Time per Stage</p>
              ...
              <div key={stage.name} className="group">
                <div className="flex items-center justify-between mb-1">
                  ...
                  <div className="text-right">
                    <span className={`text-sm font-semibold ${pastSLA ? 'text-[#c41c1c]' : 'text-[#111111]'}`}>
                ...
                <div className="relative w-full h-2 bg-[#ebe7e1] rounded-full overflow-hidden">
                  <div
                  ...
                  {stage.sla_hours > 0 && maxHours > 0 && (
                    <div
                      className="absolute top-0 h-full w-0.5 bg-[#9c9fa5]/40"
