    ...
    <div className="space-y-6 max-w-[1280px]">
      ...
      <div className="flex items-start justify-between gap-4 flex-wrap">
        <div>
          ...
          <p className="text-sm text-muted-foreground mt-0.5">Manage real estate listings, tracking unit availability and details</p>
        </div>
            ...
            <div className="space-y-4 py-2">
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <Label htmlFor="title" className="text-xs font-semibold text-muted-foreground">Property Title *</Label>
                  <Input
                    id="title"
              ...
              <div className="grid grid-cols-2 gap-4">
                <div className="space-y-1">
                  <Label htmlFor="address" className="text-xs font-semibold text-muted-foreground">Street Address *</Label>
                  <Input
                    id="address"
              ...
              <div className="grid grid-cols-4 gap-3">
                ...
                <div className="space-y-1">
                  <Label htmlFor="bedrooms" className="text-xs font-semibold text-muted-foreground">Beds</Label>
                  <Input
                    id="bedrooms"
                    type="number"
                    value={bedrooms}
                ...
                <div className="space-y-1">
                  <Label htmlFor="bathrooms" className="text-xs font-semibold text-muted-foreground">Baths</Label>
                  <Input
                    id="bathrooms"
                    type="number"
                    value={bathrooms}
              ...
              <div className="grid grid-cols-3 gap-3">
                <div className="space-y-1">
                  <Label htmlFor="sqft" className="text-xs font-semibold text-muted-foreground">Square Footage (sqft) *</Label>
                  <Input
                    id="sqft"
                    type="number"
                    value={squareFootage}
              ...
              <div className="space-y-1">
                <Label htmlFor="image_url" className="text-xs font-semibold text-muted-foreground">Photo URL</Label>
                <Input
                  id="image_url"
              ...
              <div className="space-y-1">
                <Label htmlFor="desc" className="text-xs font-semibold text-muted-foreground">Public Description</Label>
                <textarea
                  id="desc"
                  rows={2}
      ...
      <div className="grid gap-6 md:grid-cols-4 items-start">
        ...
        <Card className="bg-card border-border rounded-xl shadow-none">
          ...
          <CardContent className="space-y-4">
            <div className="space-y-1">
              <Label htmlFor="f-city" className="text-xs text-muted-foreground">City</Label>
              <Input
                id="f-city"
                placeholder="E.g., Boston"
                value={filterCity}
                onChange={(e) => setFilterCity(e.target.value)}
                className="bg-background border-border h-8 text-xs placeholder:text-muted-foreground"
              />
            </div>
            ...
            <div className="space-y-1">
              <Label htmlFor="f-beds" className="text-xs text-muted-foreground">Min Bedrooms</Label>
              <Input
                id="f-beds"
                type="number"
                placeholder="2"
        ...
        <div className="md:col-span-3">
          {loadingProperties ? (
            ...
            <Card className="bg-card border-border rounded-xl shadow-none py-12 text-center">
              ...
              <p className="text-sm font-medium text-foreground">No properties listed</p>
              <p className="text-xs text-muted-foreground mt-1">Create a property listing to get started.</p>
            </Card>
          ) : (
            <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
              {properties.map((prop: Property) => (
                <Card key={prop.id} className="bg-card border-border rounded-xl shadow-none hover:shadow-md transition-all overflow-hidden flex flex-col justify-between">
                  <div>
                    {prop.images?.[0] ? (
                      <div className="h-40 w-full overflow-hidden bg-background relative">
                        <img
                          src={prop.images[0]}
                          alt={prop.title}
                      ...
                      <div className="h-40 w-full bg-background flex items-center justify-center relative">
                    ...
                    <CardContent className="p-4 space-y-2">
                      <div>
                        ...
                        <p className="text-2xs text-muted-foreground flex items-center gap-0.5 mt-0.5">
                          <MapPin size={10} />
                      ...
                      {prop.description && (
                        <p className="text-2xs text-muted-foreground line-clamp-2 italic">
                          "{prop.description}"
                        </p>
                      )}
                  ...
                  <CardFooter className="p-3 border-t border-border flex justify-end gap-1.5 bg-background/20">
                    <Button
                      size="icon"
                      variant="ghost"
